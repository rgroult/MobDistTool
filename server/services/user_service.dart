  ...
  Future<Response> userForgotPassword(PasswordRecoveryMessage message) async {
    ...
    if (user != null){
      if (needRegistration && confirmationUrl != null && emailTransport != null) {
        ...
        //reset user
        user = await users.resetUser(user,newPassword);
        ...
        var htmlContent = """
            ...
            <body>
              <div style='text-align: center'>
                <img src='data:image/png;base64,' />
                <span style='line-height:78px;'><b>Mobile App Distribution Tool</b></span>
              </div>
        ...
        return new Response(200,{'message':'Your account has been temporarily desactivated, a email with new password and activation link was sent'});
      }else {
        throw new RpcError(
