...
Future addFileToArtifact(File file,MDTArtifact artifact,BaseStorageManager storageMgr) async {
  ...
  //store new file
  try {
    var storageInfos = await storageMgr.storeFile(file, platform:artifact.application.platform , appName:artifact.application.name, version:artifact.version, filename:artifact.filename, contentType:artifact.contentType);
